...
result_tree_canopy_layer = QgsRasterLayer(output_path, 'NLCD_' + year +  '_' + state + part + '_Tree_Land_Combined_4326')
QgsProject.instance().addMapLayer(result_tree_canopy_layer)
...
#combined_layer = QgsProject.instance().mapLayersByName('NLCD_' + year +  '_' + state + part + '_Tree_Land_Combined_4326')[0]
